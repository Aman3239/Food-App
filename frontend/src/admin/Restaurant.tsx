...
const Restaurant = () => {
  ...
  const { loading, restaurant, updateRestaurant, getRestaurant, createRestaurant } = useRestaurantStore();
  ...
  const submitHandler = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!result.success) {
      ...
      setErrors(filedErrors as Partial<RestaurantFormSchema>)
      return;
    }
            ...
            <div className="md:grid grid-cols-2 gap-6 space-y-2 md:space-y-0">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Enter Your restaurnt name"
                />
                {
