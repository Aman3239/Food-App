    ...
    return (
        <div className="flex flex-col max-w-7xl mx-auto my-10">
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <div className="w-fit flex items-center rounded-full border border-gray-100 dark:border-gray-800 shadow-md">
                                        ...
                                        <Button size={"icon"} disabled variant={"outline"} className="font-bold border-none">{item.quantity}</Button>
                                ...
                                <TableCell className="text-right">
                                    <Button size={"sm"} onClick={()=>removeFromTheCart(item._id)} className="bg-orange hover:bg-hoverOrange">Remove</Button>
                                </TableCell>
                            </TableRow>
                        ))
                    }
            ...
            <div className="flex justify-end my-5">
                <Button onClick={() => setOpen(true)} className="bg-hoverOrange hover:bg-hoverOrange">Proceed To Checkout</Button>
            </div>
