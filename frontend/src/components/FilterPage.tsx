...
//agar applied filter k ander ye item exist krta he to iska mtlb checked he
      ...
      </div>
      {
        filterOptions.map((option) => (
          <div key={option.id} className="flex items-center space-x-2 my-5">
            ...
            />
            <Label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-default:opacity-70">{option.label}</Label>
          </div>
        ))
      }
    </div>
