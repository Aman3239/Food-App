    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4">
            <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 max-w-lg  w-full">
                                        ...
                                        <div className="mb-4">
                                            <div className="flex justify-between items-center">
                                                <div className="flex items-center">
                                                    ...
                                                    <h3 className="ml-2 text-gray-800 dark:text-gray-200 font-medium">({item.quantity})</h3>
                                                    <h3 className="ml-2 text-gray-800 dark:text-gray-200 font-medium">{item.name}</h3>
                                                </div>
                ...
                <Link to={"/cart"}>
                    <Button className="bg-orange hover:bg-hoverOrange w-full py-3 rouded-md shadow-lg">Continue Shopping</Button>
                </Link>
            </div>
        </div>
    )
